...
CGFloat const STATUS_NAVIGATION_BAR_HEIGHT = 64.0;         // 状态栏+导航条高度(系统默认高度为64)
CGFloat const STATUS_BAR_HEIGHT = 20.0;                    // 状态栏高度(系统默认高度为20)
CGFloat const NAVIGATION_BAR_HEIGHT = 44.0;                // 导航条高度(系统默认高度为44)
